...
public class LocationUtils {
    ...
    private static final String EPSG_5174_PARAMS = "+proj=tmerc +lat_0=38 +lon_0=127.0028902777778 +k=1 +x_0=200000 +y_0=500000 +ellps=bessel +units=m +no_defs +towgs84=-115.80,474.99,674.11,1.16,-2.31,-1.63,6.43";
    private static final String WGS84CRS = "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs";
    ...
    public static ProjCoordinate CoordinateConversion(String x, String y) {
        ...
        if (x == null || y == null || x.isEmpty() || y.isEmpty()) {
            log.warn("Invalid latitude or longitude. Returning default coordinates.");
            return null;
        }
